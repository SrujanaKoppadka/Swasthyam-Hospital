		...
		>
			<div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
				...
				<div className="flex flex-col items-center md:items-start">
					...
					<ul className="space-y-4 text-slate-400 text-base w-full">
						{/* Appointments */}
				...
				<div className="flex flex-col items-center md:items-start">
					...
					>
						...
						<a
							href={`tel:${CONTACT_INFO.emergency}`}
							className="w-full block text-center bg-red-600 hover:bg-red-700 text-white py-2.5 rounded-lg font-medium transition-all hover:-translate-y-0.5 hover:shadow-lg text-base"
						>
			...
			<div
				className="max-w-7xl mx-auto px-6 py-6 pb-24 md:pb-6 flex flex-col items-center md:flex-row md:justify-between gap-3 text-sm text-slate-500 text-center"
